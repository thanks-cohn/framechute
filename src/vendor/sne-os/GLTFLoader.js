...
class GLTFLoader extends Loader {
	...
	load( url, onLoad, onProgress, onError ) {
		...
		if ( this.resourcePath !== '' ) {
			...
			// Example  path = 'example-cdn.invalid/', url = 'assets/models/model.gltf'
			// resourcePath = 'example-cdn.invalid/assets/models/'
			// referenced resource 'model.bin' will be loaded from 'example-cdn.invalid/assets/models/model.bin'
			// referenced resource '../textures/texture.png' will be loaded from 'example-cdn.invalid/assets/textures/texture.png'
