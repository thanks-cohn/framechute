...
export function commandsForEditorContext(context) {
  ...
  if (context.editorKind === "docx") {
    ...
    const format = [
      {id:"bold",label:"Bold"},{id:"italic",label:"Italic"},{id:"underline",label:"Underline"},{id:"strike",label:"Strikethrough"},
      {id:"highlight",label:"Highlight Selection"},{id:"remove-highlight",label:"Remove Highlight"},{id:"clear-format",label:"Clear direct formatting"},
      {type:"separator"},{id:"font",label:"Font…"},{id:"paragraph",label:"Paragraph…"},{id:"align-left",label:"Align left"},{id:"align-center",label:"Center"},{id:"align-right",label:"Align right"},{id:"align-full",label:"Justify"},{id:"bullet",label:"Bullets"},{id:"number",label:"Numbering"},{id:"indent",label:"Increase indent"},{id:"outdent",label:"Decrease indent"}
    ];
