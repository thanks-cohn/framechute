...
export async function createPdfPageDiagnostics(model,edits,pageNumber,{viewport=null,observations=[],pageGeometry=null,pointerHitTest=null,interactionJournal=[],mutationJournal=[],selectedObjectId=null,editingObjectId=null}={}){
