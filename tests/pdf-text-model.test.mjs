...
import { layoutPdfText, PDF_STANDARD_FONTS, resolvePdfStandardFont, serializeEditedPdf } from "../src/documents/pdf-document.js";
...
test("PDF text layout preserves newlines, repeated spaces, and wraps to width", () => {
  ...
  assert.deepEqual(layoutPdfText("one  two\n\nthree", font, 12, 100), ["one  two", "", "three"]);
  assert.deepEqual(layoutPdfText("abcdef", font, 12, 15), ["abc", "def"]);
});
